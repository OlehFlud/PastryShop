    ...
    <div className={'w-full'}>
      <div className={'flex flex-col gap-4 sm:mt-32 mb-24'}>
        <div className={'flex flex-col gap-4 sm:mt-32'}>
          <h1 className={'font-tan-pearl text-main text-[35px] sm:text-[40px] md:text-[50px] lg:text-[60px] xl:text-[85px] sm:mt-10'}>Our Product</h1>
            <p className={'font-normal text-main  ld:text-[24px] md:text-[24px] sm:text-[20px] text-[16px] mt-4 sm:mt-10'}>
